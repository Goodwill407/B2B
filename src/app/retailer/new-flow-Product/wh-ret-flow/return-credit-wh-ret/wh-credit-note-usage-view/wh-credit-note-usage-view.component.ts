...
@Component({
  selector: 'app-wh-credit-note-usage-view',
  standalone: true,
  imports: [
    CommonModule,
    RouterModule,
  ...
  templateUrl: './wh-credit-note-usage-view.component.html',
  styleUrl: './wh-credit-note-usage-view.component.scss'
})
export class WhCreditNoteUsageViewComponent implements OnInit {
