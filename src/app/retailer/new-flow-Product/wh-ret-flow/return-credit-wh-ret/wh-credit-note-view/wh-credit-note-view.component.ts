...
@Component({
  selector: 'app-wh-credit-note-view',
  standalone: true,
  imports: [
    CommonModule,
    RouterModule,
  ...
  templateUrl: './wh-credit-note-view.component.html',
  styleUrl: './wh-credit-note-view.component.scss'
})
export class WhCreditNoteViewComponent implements OnInit {
