...
@Component({
  selector: 'app-mfg-group-credit-note-list',
  standalone: true,
  imports: [
    CommonModule,
    RouterModule,
  ...
  templateUrl: './mfg-group-credit-note-list.component.html',
  styleUrl: './mfg-group-credit-note-list.component.scss'
})
export class MfgGroupCreditNoteListComponent implements OnInit {
  ...
  getAvailableCreditNotes() {
    ...
    const url = `m-r-credit-note/group?retailerEmail=${retailerEmail}&page=${page}&limit=${this.limit}&used=false`;
