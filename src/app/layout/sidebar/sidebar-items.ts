...
export const ROUTES: RouteInfo[] = [
  ...
  },
  {
    ...
    submenu: [
      ...
      {
        path: '/mnf/wh-asign-prod',
        title: 'Assign Product Wholesaler',
        iconType: '',
        icon: '',
        class: 'ml-menu',
        groupTitle: false,
  ...
  },
{
...

  {
    ...
    submenu: [
      ...
      {
        path: '/mnf/new/whl-credit-note-group-list',
        title: 'Wholesaler Credit Note',
        iconType: '',
        icon: '',
        class: 'ml-menu',
        groupTitle: false,
...
// },
  ...
  
  {
    ...
    submenu: [
      ...
      {
        path: '/retailer/new/mfg-invoice-list',
      ...
      {
        path: '/retailer/new/wh-invoice-list',
        title: 'Wholesaler Invoice',
        iconType: '',
        icon: '',
        class: 'ml-menu',
  ...
  },
 {
    ...
    submenu: [
      ...
      {
        path: '/retailer/new/mfg-group-credit-note-list',
        title: 'Manufacturer Credit Note',
        iconType: '',
        icon: '',
        class: 'ml-menu',
        groupTitle: false,
      ...
      {
        path: '/retailer/new/whl-invoice-list-return',
        title: 'Add Return Wholesaler ',
        iconType: '',
        icon: '',
        class: 'ml-menu',
        groupTitle: false,
      ...
      {
        path: '/retailer/new/return-products-whl-list',
        title: 'View Return Wholesaler',
        iconType: '',
        icon: '',
        class: 'ml-menu',
        groupTitle: false,
      ...
      {
        path: '/retailer/new/wh-group-credit-note-list',
        title: 'Wholesaler Credit Note',
        iconType: '',
        icon: '',
        class: 'ml-menu',
  ...
  },
  {
    ...
    submenu: [
      ...
      {
        path: '/wholesaler/wh-update-stock-of-product',
        title: `Stock Inventory`,
        iconType: '',
        icon: '',
        class: 'ml-menu',
...

  {
    ...
    submenu: [
      ...
      // },
        {
        path: '/wholesaler/new/product/po-quantity-updated-bymfg',
      ...
      },
      {
       ...
       {
        path: '/wholesaler/ret-wh-flow/ret-wh-po-list',
        title: 'Retailer New Orders',
        iconType: '',
        icon: '',
        class: 'ml-menu',
      ...
      {
        path: '/wholesaler/ret-wh-flow/ret-wh-invoice-list',
      ...
      //   title: 'Retailer-Manufacturer-Combined-Po',
      //   iconType: '',
      //   icon: '',
      //   class: 'ml-menu',
      //   groupTitle: false,
  ...
  },
  {
    ...
    submenu: [
      ...
      {
        path: '/wholesaler/return-mng/whl-return-order-list',
        title: 'View Return Order',
        iconType: '',
        icon: '',
        class: 'ml-menu',
        groupTitle: false,
      ...
      {
        path: '/wholesaler/return-mng/wh-mfg-group-credit-note',
        title: 'Credit Note',
        iconType: '',
        icon: '',
        class: 'ml-menu',
      ...
      {
        path: '/wholesaler/ret-wh-flow/ret-wh-Return-order-ret-list',
        title: 'Retailer Return Order',
        iconType: '',
        icon: '',
        class: 'ml-menu',
      ...
      {
        path: '/wholesaler/ret-wh-flow/ret-wh-credit-note-group-list',
        title: 'Retailer Credit Note',
        iconType: '',
        icon: '',
        class: 'ml-menu',
