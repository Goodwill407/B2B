...
@Component({
  selector: 'app-ret-wh-credit-note-list',
  standalone: true,
  imports: [
    CommonModule,
    TableModule,
  ...
  templateUrl: './ret-wh-credit-note-list.component.html',
  styleUrl: './ret-wh-credit-note-list.component.scss'
})
export class RetWhCreditNoteListComponent implements OnInit {
  ...
  getCreditNotes() {
    ...
    const url = `w-r-credit-note?wholesalerEmail=${this.wholesalerEmail}&retailerEmail=${this.retailerEmail}&used=${this.used}&page=${this.currentPage}&limit=${this.rows}&sortBy=createdAt:desc`;
