...
@Component({
  ...
  templateUrl: './ret-wh-po-list.component.html',
  styleUrl: './ret-wh-po-list.component.scss'
})
export class RetWhPoListComponent {
  ...
  getPendingData() {
    ...
    this.authService.get(`po-retailer-to-wholesaler?wholesalerEmail=${this.authService.currentUserValue.email}&statusAll=pending&page=${page}&limit=${limit}`)
      .subscribe((res: any) => {
  ...
  getPartialData() {
    ...
    this.authService.get(`po-retailer-to-wholesaler?wholesalerEmail=${this.authService.currentUserValue.email}&statusAll=partial_delivery&page=${page}&limit=${limit}`)
      .subscribe((res: any) => {
  ...
  getMaketoOrderData() {
    ...
    this.authService.get(`po-retailer-to-wholesaler?wholesalerEmail=${this.authService.currentUserValue.email}&sortBy=createdAt:desc&statusAll=w_make_to_order&page=${page}&limit=${limit}`)
      .subscribe((res: any) => {
  ...
  getConfirmedData() {
    ...
    this.authService.get(`po-retailer-to-wholesaler?wholesalerEmail=${this.authService.currentUserValue.email}&sortBy=createdAt:desc&statusAll=wholesaler_confirmed&page=${page}&limit=${limit}`)
      .subscribe((res: any) => {
