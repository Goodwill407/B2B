...
@Component({
  selector: 'app-whl-return-order-list',
  standalone: true,
  imports: [
    CommonModule,
    TableModule,
  ...
  templateUrl: './whl-return-order-list.component.html',
  styleUrl: './whl-return-order-list.component.scss'
})
export class WhlReturnOrderListComponent implements OnInit {
  ...
  getReturnOrders(): void {
    ...
    const url = `return-w2m?wholesalerEmail=${wholesalerEmail}&page=${this.currentPage}&limit=${this.rows}&sortBy=createdAt:desc`;
