...
@Component({
  selector: 'app-view-product-re-price',
  standalone: true,
  imports: [TableModule,
    PaginatorModule,
    NgIf, RouterModule,
  ...
  templateUrl: './view-product-re-price.component.html',
  styleUrl: './view-product-re-price.component.scss'
})
export class ViewProductRePriceComponent {
