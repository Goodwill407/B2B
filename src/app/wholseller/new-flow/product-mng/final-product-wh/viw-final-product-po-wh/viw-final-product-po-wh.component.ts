...
@Component({
  selector: 'app-viw-final-product-po-wh',
  standalone: true,
  imports: [CommonModule, FormsModule, AccordionModule, TableModule],
  templateUrl: './viw-final-product-po-wh.component.html',
  styleUrl: './viw-final-product-po-wh.component.scss'
})
export class ViwFinalProductPoWhComponent {
  purchaseOrder: any = {
    supplierName: '',
    supplierDetails: '',
    supplierAddress: '',
  ...
  getAllProducts() {
    const url = `final-product/${this.distributorId}`;
