...
@Component({
  selector: 'app-view-delivery-final',
  standalone: true,
  ...
  templateUrl: './view-delivery-final.component.html',
  styleUrl: './view-delivery-final.component.scss'
})
export class ViewDeliveryFinalComponent {
  purchaseOrder: any = {
    supplierName: '',
    supplierDetails: '',
    supplierAddress: '',
