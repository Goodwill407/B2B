...
@Component({
  selector: 'app-whl-credit-note-view',
  standalone: true,
  imports: [
    CommonModule,
    RouterModule,
  ...
  templateUrl: './whl-credit-note-view.component.html',
  styleUrl: './whl-credit-note-view.component.scss'
})
export class WhlCreditNoteViewComponent implements OnInit {
  ...
  getCreditNoteDetails() {
    this.loading = true;
    const url = `m-w-credit-note/${this.creditNoteId}`;  // ✅ wholesaler endpoint
  ...
  // ✅ wholesaler discount instead of retailer
