...
export class RetailerToManPoListComponent {
 purchaseOrder: any = {
    supplierName: '',
    supplierDetails: '',
    supplierAddress: '',
  ...
  getAllData() {
    this.showFlag = false;
    this.authService.get(`po-retailer-to-manufacture?manufacturerEmail=${this.authService.currentUserValue.email}&sortBy=createdAt:desc&limit=${this.limit}&page=${this.page}`).subscribe((res: any) => {
