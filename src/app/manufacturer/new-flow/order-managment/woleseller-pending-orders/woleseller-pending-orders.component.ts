...
@Component({
  selector: 'app-woleseller-pending-orders',
  standalone: true,
  imports: [
    CommonModule,
    TableModule,
  ...
  templateUrl: './woleseller-pending-orders.component.html',
  styleUrl: './woleseller-pending-orders.component.scss'
})
export class WolesellerPendingOrdersComponent {
  purchaseOrder: any = {
    supplierName: '',
    supplierDetails: '',
    supplierAddress: '',
