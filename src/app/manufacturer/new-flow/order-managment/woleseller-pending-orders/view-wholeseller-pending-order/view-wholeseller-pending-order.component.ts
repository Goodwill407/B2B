...
@Component({
  selector: 'app-view-wholeseller-pending-order',
  standalone: true,
  imports: [CommonModule, FormsModule, AccordionModule, TableModule],
  templateUrl: './view-wholeseller-pending-order.component.html',
  styleUrl: './view-wholeseller-pending-order.component.scss'
})
export class ViewWholesellerPendingOrderComponent {
  purchaseOrder: any = {
    supplierName: '',
    supplierDetails: '',
    supplierAddress: '',
